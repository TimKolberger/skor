...
import { generatePlayerName } from '../../players/generate-player-name'
import { playerColors } from '../../players/player-colors'
import { generateRoomName } from '../../rooms/generate-room-name'
import type { Player, ScoreAction } from '../../rooms/use-players'
import { type Room, useRoomStore } from '../../rooms/use-rooms'
